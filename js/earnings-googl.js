...
(function () {
  ...
  window.__enthusiaEarnings['GOOGL'] = { ticker: 'GOOGL', period: 'Q1 2026', KPI, GUIDANCE, download: downloadPNG };
  window.dispatchEvent(new CustomEvent('enthusia-earnings-ready', { detail: { ticker: 'GOOGL' } }));
})();

...
(function () {
  ...
  window.__enthusiaEarnings['APP'] = { ticker: 'APP', period: 'Q1 2026', KPI, GUIDANCE, download: downloadPNG };
  window.dispatchEvent(new CustomEvent('enthusia-earnings-ready', { detail: { ticker: 'APP' } }));
})();

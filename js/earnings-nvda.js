...
(function () {
  ...
  window.__enthusiaEarnings['NVDA'] = { ticker: 'NVDA', period: 'Q1 FY27', KPI, GUIDANCE, download: downloadPNG };
  window.dispatchEvent(new CustomEvent('enthusia-earnings-ready', { detail: { ticker: 'NVDA' } }));
})();

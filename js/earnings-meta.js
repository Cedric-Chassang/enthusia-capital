...
(function () {
  ...
  window.__enthusiaEarnings['META'] = { ticker: 'META', period: 'Q1 2026', KPI, GUIDANCE, download: downloadPNG };
  window.dispatchEvent(new CustomEvent('enthusia-earnings-ready', { detail: { ticker: 'META' } }));
})();
